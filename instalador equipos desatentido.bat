...
@echo ------------------------------------------------------
@echo Cargando Registro TATA1
@echo ------------------------------------------------------
c:\PuTTY\RegPuTTy.reg
@echo ------------------------------------------------------
@RHPRO
mkdir "C:\RHPRO"
@echo -----------------------------------------------------
...
@echo ---------------------------------------------------
@echo ---------------------------------------------------
C:\Ruticola\Ruticola.reg
@echo -------------------------------------------------
@echo Registro cargado corretamente
@echo -------------------------------------------------
@echo Printfil
@echo ----------------------------------------------------
C:\autoinstalable\Printfil.exe /SILENT
C:\autoinstalable\Ta-Ta.pfl  
@echo ----------------------------------------------------
@echo 7zip
@echo -----------------------------------------------------
C:\autoinstalable\7zip.exe /S
